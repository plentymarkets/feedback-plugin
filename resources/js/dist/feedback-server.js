...
var render = function render() {
  ...
  }) : _vm._e(), _vm._ssrNode(" " + (!!_vm.editableFeedback && _vm.isReply ? '<div><div class="form-group"><textarea rows="3"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.replyMessage")) + ' class="form-control">' + _vm._ssrEscape(_vm._s(_vm.editableFeedback.message)) + '</textarea></div> <button class="btn btn-primary btn-appearance">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.editReply")) + "\n    ") + '</button> <button class="btn btn-secondary feedback-edit-cancel">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.cancel")) + "\n    ") + "</button></div>" : "<!---->") + " " + (!!_vm.editableFeedback && !_vm.isReply ? '<div><div class="stars"><fieldset><legend><span class="visually-hidden">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackTextLegend"))) + "</span></legend> " + _vm._ssrList([5, 4, 3, 2, 1], function (i) {
    return "<input" + _vm._ssrAttr("id", "star-" + _vm._uid + "-" + i) + ' type="radio" name="ratingValue"' + _vm._ssrAttr("value", i) + _vm._ssrAttr("checked", _vm._q(_vm.editableFeedback.ratingValue, i)) + _vm._ssrClass(null, "star star-" + i) + "> <label" + _vm._ssrAttr("for", "star-" + _vm._uid + "-" + i) + _vm._ssrClass(null, "star star-" + i) + '><span class="visually-hidden">' + _vm._ssrEscape(_vm._s(i) + " " + _vm._s(_vm.$translate("Feedback::Feedback.feedbackAverageLabel"))) + "</span></label>";
  }) + '</fieldset></div> <div class="form-group"><input' + _vm._ssrAttr("id", "label_title_" + _vm._uid) + ' type="text"' + _vm._ssrAttr("name", "title_" + _vm._uid) + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.title")) + ' required="required"' + _vm._ssrAttr("value", _vm.editableFeedback.title) + ' class="form-control"> <label' + _vm._ssrAttr("for", "label_title_" + _vm._uid) + ' class="position-absolute"><span class="visually-hidden">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.title"))) + '</span></label></div> <div class="form-group"><textarea' + _vm._ssrAttr("id", "label_message_" + _vm._uid) + _vm._ssrAttr("name", "message_" + _vm._uid) + ' rows="3"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.title")) + ' class="form-control">' + _vm._ssrEscape(_vm._s(_vm.editableFeedback.message)) + "</textarea> <label" + _vm._ssrAttr("for", "label_message_" + _vm._uid) + ' class="position-absolute"><span class="visually-hidden">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.title"))) + '</span></label></div> <button class="btn btn-primary btn-appearance">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.editReview")) + "\n    ") + '</button> <button class="btn btn-secondary feedback-edit-cancel">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.cancel")) + "\n    ") + "</button></div>" : "<!---->"))], 2);
};
var staticRenderFns = [];
render._withStripped = true;
