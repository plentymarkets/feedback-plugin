...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_17__.mapState)({
    authenticatedUser: function authenticatedUser(state) {
      return state.feedback.authenticatedUser;
    }
  })),
...
var render = function render() {
  ...
  return _c("div", [_vm.authenticatedUser.isLoggedIn || _vm.options.allowGuestFeedbacks ? _vm._ssrNode('<div class="createFeedback">', "</div>", [_vm._ssrNode('<div class="stars"><fieldset><legend><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackTextLegend"))) + "</span></legend> " + _vm._ssrList([5, 4, 3, 2, 1], function (i) {
    return "<input" + _vm._ssrAttr("id", "star-" + i + _vm._uid) + ' type="radio"' + _vm._ssrAttr("name", "ratingValue" + _vm._uid) + _vm._ssrAttr("title", "ratingValue" + _vm._uid) + _vm._ssrAttr("value", i) + _vm._ssrAttr("checked", _vm._q(_vm.feedback.ratingValue, i)) + _vm._ssrClass(null, "star star-" + i) + "> <label" + _vm._ssrAttr("for", "star-" + i + _vm._uid) + _vm._ssrClass(null, "star star-" + i) + "><span>" + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackAverageLabel"))) + "</span></label>";
...
var render = function render() {
  ...
  }, [_vm._ssrNode('\n      pencil\n      <i class="fa fa-pencil"></i>')]) : _vm._e(), _vm._ssrNode(" "), _vm.authenticatedUser.isLoggedIn ? _c("span", {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip"
    }],
  ...
  }, [_vm._ssrNode('<i class="fa fa-trash-o"></i>')]) : _vm._e()], 2) : _vm._e(), _vm._ssrNode("\n  feedback-comment\n  "), !_vm.editableFeedback ? _c("feedback-comment", {
    attrs: {
  ...
  }) : _vm._e(), _vm._ssrNode("\n  aaa\n  " + (!!_vm.editableFeedback && _vm.isReply ? '<div><div class="form-group"><textarea rows="3"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.replyMessage")) + ' class="form-control">' + _vm._ssrEscape(_vm._s(_vm.editableFeedback.message)) + '</textarea></div> <button class="btn btn-primary btn-appearance">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.editReply")) + "\n    ") + '</button> <button class="btn btn-secondary feedback-edit-cancel">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.cancel")) + "\n    ") + "</button></div>" : "<!---->") + " " + (!!_vm.editableFeedback && !_vm.isReply ? '<div>\n    test\n    <div class="stars">' + _vm._ssrList([5, 4, 3, 2, 1], function (i) {
    return "<input" + _vm._ssrAttr("id", "star-" + _vm._uid + "-" + i) + ' type="radio" name="ratingValue"' + _vm._ssrAttr("value", i) + _vm._ssrAttr("checked", _vm._q(_vm.editableFeedback.ratingValue, i)) + _vm._ssrClass(null, "star star-" + i) + "> <label" + _vm._ssrAttr("for", "star-" + _vm._uid + "-" + i) + _vm._ssrClass(null, "star star-" + i) + '><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackAverageLabel"))) + "</span></label>";
  }) + '</div> <div class="form-group"><input type="text" name="title"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.title")) + _vm._ssrAttr("title", _vm.$translate("Feedback::Feedback.title")) + ' required="required"' + _vm._ssrAttr("value", _vm.editableFeedback.title) + ' class="form-control"></div> <div class="form-group"><textarea name="message" rows="3"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.title")) + _vm._ssrAttr("title", _vm.$translate("Feedback::Feedback.feedbackLabel")) + ' class="form-control">' + _vm._ssrEscape(_vm._s(_vm.editableFeedback.message)) + '</textarea></div> <button class="btn btn-primary btn-appearance">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.editReview")) + "\n    ") + '</button> <button class="btn btn-secondary feedback-edit-cancel">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.cancel")) + "\n    ") + "</button></div>" : "<!---->"))], 2);
};
var staticRenderFns = [];
render._withStripped = true;
...
var render = function render() {
  ...
  }) + '</div></fieldset></div> <div class="col-8"><a' + _vm._ssrAttr("id", "feedbackOrderItem-" + _vm._uid) + _vm._ssrAttr("href", _vm.item.url) + ' class="mb-3">' + _vm._ssrEscape(_vm._s(_vm.item.name) + "\n            ") + _vm._ssrList(_vm.item.attributes, function (attribute) {
